...
# =========================================================
# 카탈로그 (M002/M006 DB) — 사용자에게는 읽기 전용으로 제공
# =========================================================
...
class Package(models.Model):
    """여행 패키지 상품 (M002-F-001 / M005-F-003,004 / M006-F-003)."""
...
# =========================================================
# 최종 여행 일정 (M004 / M006-F-002) — 사용자 소유 데이터
# =========================================================

class Itinerary(models.Model):
    """최종 여행 일정표 (M004-F-001,002,003,004,005,007)."""
    ...
    def total_cost(self) -> int:
        """M004-F-005 예상 총비용(평균) = 카테고리별 비용 합산."""
        return (
...
class ItineraryItem(models.Model):
    """일자별 일정 항목 (M004-F-003,004) — 추천 결과 또는 사용자가 직접 추가."""
    ...
    # 카탈로그 연동 (선택) — 추천 결과에서 가져온 경우 원본 참조
